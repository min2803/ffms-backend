...
const ExpenseService = {
    ...
    /**
     * Lấy danh sách expenses theo household — trả raw array, frontend tự transform
     */
    async getExpensesByHousehold(userId, householdId, type = "family") {
        ...
        // If current user is a member, hide detail of owner's expenses
        const currentRole = member.role;
        if (currentRole === "member") {
            expenses = expenses.map(e => ({
                ...e,
                hide_details: e.user_role === "owner",
            }));
        }
